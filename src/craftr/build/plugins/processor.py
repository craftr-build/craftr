...
from craftr.core import Namespace, Project, Property, DefaultTask


class ProcessorTask(DefaultTask):
  inputs: te.Annotated[Property[t.List[Path]], DefaultTask.Input]
  outputs: te.Annotated[Property[t.List[Path]], DefaultTask.Output]
  additional_vars: te.Annotated[Property[t.Dict[str, t.List[str]]], DefaultTask.Input]
