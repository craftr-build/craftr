...
class ClassInstantiationError(Exception):
  """
  This error is raised when a class failed to be instantiated from a {@link Settings} object.
  """
...
class Settings(abc.ABC):
  ...
  def create_instance(self, type: t.Type[T], fqn: str, config_key: str = '<notset>') -> T:
    ...
    the {@link LoadableFromSettings} protocol, the method will be called to create an instance.
    """
